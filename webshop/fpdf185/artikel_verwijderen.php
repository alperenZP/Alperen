...
<?php
    ...
    $sql = "DELETE FROM tblartikels WHERE artikelnummer = ".$_GET["teverwijderen"];
    ...
    if ($mysqli->query($sql)) {
        echo '
            <div class="w3-content" style="max-width:1100px">
                <div class="w3-container w3-padding-64" id="contact">
                    <h1>Succes</h1><br>
                    <p>Artikel succesvol verwijderd, klik <a href="artikel_menu.php">hier</a> om terug te gaan.</p>
                </div> 
            </div>
        ';
    } else {
        echo '
            <div class="w3-content" style="max-width:1100px">
                <div class="w3-container w3-padding-64" id="contact">
                    <h1>Mislukking</h1><br>
                    <p>Error artikel verwijderen, '.$mysqli->error.'</p>
                </div> 
            </div>
        ';
    }
