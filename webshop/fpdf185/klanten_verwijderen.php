...
<html>
<head>
<title>Klanten verwijderen</title>
<meta charset="UTF-8">
...
<?php
    ...
    $sql = "DELETE FROM tblgebruikers WHERE gebruikernummer = ".$_GET["teverwijderen"];
    ...
    if ($mysqli->query($sql)) {
        echo '
            <div class="w3-content" style="max-width:1100px">
                <div class="w3-container w3-padding-64" id="contact">
                    <h1>Succes</h1><br>
                    <p>Klant succesvol verwijderd, klik <a href="klanten_lijst.php">hier</a> om terug te gaan.</p>
                </div> 
            </div>
        ';
    } else {
        echo '
            <div class="w3-content" style="max-width:1100px">
                <div class="w3-container w3-padding-64" id="contact">
                    <h1>Mislukking</h1><br>
                    <p>Error klant verwijderen, '.$mysqli->error.'</p>
                </div> 
            </div>
        ';
    }
